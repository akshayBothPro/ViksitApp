...
public class QuestionsResultRecyclerViewAdapter extends  RecyclerView.Adapter<QuestionsResultRecyclerViewAdapter.MyJobViewHolder>{

    private List<QuestionPOJO> questions;
    private Context context;
    private LockableViewPager lockableViewPager;
    private AssessmentResult assessmentActivity;



    public QuestionsResultRecyclerViewAdapter(Context context, AssessmentResult assessmentActivity, LockableViewPager lockableViewPager, List<QuestionPOJO> questions) {
