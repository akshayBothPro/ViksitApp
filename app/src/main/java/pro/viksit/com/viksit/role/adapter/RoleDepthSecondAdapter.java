...
public class RoleDepthSecondAdapter extends ExpandableRecyclerAdapter<RoleParent,RoleChild,RoleSkillViewHolder,RoleNameViewHolder> {

    List<RoleParent> roleParents;
    private LayoutInflater mInflater;
    private Context context;

    public RoleDepthSecondAdapter(Context context, @NonNull List<RoleParent> roleParents) {
        super(roleParents);
