...
public class PresentationFragment extends Fragment {
    ...
    public static Fragment newInstance(Activity context, DashboardCard dashboardCard, float scale) {
        ...
        return Fragment.instantiate(context, PresentationFragment.class.getName(), b);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = (LinearLayout) inflater.inflate(R.layout.presentation_card, container, false);
        ...
        if(getArguments() != null){
            ...
            Button start_presentation = (Button) linearLayout.findViewById(R.id.start_presentation);
            ...
            if (diagonalInches>=6.5){
                Picasso.with(getContext())
                        .load(R.drawable.ic_1).resize(screenheitght / 2, screenheitght / 2)
                        .into(image);
            ...
            start_presentation.setOnClickListener(new View.OnClickListener() {
                @Override
